...
export default function PackageDetailSection({ images, formFields , overview , offers }) {
	return (
        ...
        <PackageOverview overview={overview} />
        <PackageOffers offers={offers} />
				{/* Other cards/components (Overview, Offers) will go here later */}
			</div>
			{/* Right: Form */}
			<div className="md:col-span-4 lg:col-span-3">
				<PackageInquiryForm fields={formFields} />
			</div>
		</section>
	);
}
